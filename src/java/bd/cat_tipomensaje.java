...
public class cat_tipomensaje extends Tabla{
     ...
     public cat_tipomensaje () {
          campos = new String[8];
          campos[0] = "idtipomensaje";
     ...
     public cat_tipomensaje (Integer idtipomensaje, String descripcion, String observaciones, Integer estatusregistro, Integer usuariocreacion, Date fechacreacion, Integer usuariomodificacion, Date fechamodificacion){
     ...
     public void setCampo(String p_nombrecampo, Object p_valorcampo){
          if(p_nombrecampo.equals("idtipomensaje")){
